...
void OnPVPKill(Player * killer, Player * killed)
{
	...
	if (killer->GetSession()->GetRemoteAddress() == killed->GetSession()->GetRemoteAddress() || killed->GetMaxHealth() < 30000) // about 1/4 of the maximum hp a character can have on your server to make this fully functional.
	{
		uint32 Warning = 1;
		std::string Acc;
